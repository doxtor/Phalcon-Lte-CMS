<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	...
	<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
		<a class="nav-link" href="/admin/site/site/list"><i class="fa fa-file"></i> Site pages</a>
	</li>
	<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
	...
	<li class="nav-item"><a href="/admin/users/users/logout" class="nav-link"><i class="fa fa-sign-out-alt"></i>Logout</a></li>
	</ul>
</div>
</nav>
